...
float Frustum::f_CameraH = 10; // check actual value
...
std::array<raylib::Vector3, 8> Frustum::MakeMesh() const {
  ...
  Mesh[1] = this->f_Origin.Add(this->f_Right.Scale(BackWidth / 2)).Add(this->f_Front.Scale(this->f_FOD)).Add(f_Up.Scale(-f_CameraH / 2));
  Mesh[2] = this->f_Origin.Add(this->f_Right.Scale(BackWidth / 2)).Add(this->f_Front.Scale(this->f_FOD)).Add(f_Up.Scale(f_CameraH / 2));
  ...
  Mesh[5] = this->f_Origin.Add(this->f_Right.Scale(BackWidth / 2)).Add(this->f_Front.Scale(this->f_FOD)).Add(f_Up.Scale(-f_CameraH / 2));
  Mesh[6] = this->f_Origin.Add(this->f_Right.Scale(BackWidth / 2)).Add(this->f_Front.Scale(this->f_FOD)).Add(f_Up.Scale(f_CameraH / 2));
